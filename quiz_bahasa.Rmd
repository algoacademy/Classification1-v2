...
```
___
1. Berdasarkan agregasi data yang telah Anda buat, divisi mana yang merupakan 3 divisi dengan rata-rata jam kerja per bulan tertinggi?
...
___
2. Berdasarkan hasil di atas, manakah pernyataan di bawah ini yang paling tepat?
...
```
___
3. Regresi logistik adalah salah satu model yang dapat diinterpretasikan. Kita dapat menjelaskan bagaimana masing-masing variabel memberikan pengaruh pada hasil prediksi. Berdasarkan ringkasan model di atas, apa yang dapat diinterpretasikan dari koefisien `salarymedium`?
  - [ ] Probabilitas karyawan yang mendapatkan medium salary untuk mengundurkan diri adalah sebesar 1.50.
  - [ ] Karyawan yang mendapatkan medium salary 1.50 kali lebih mungkin untuk mengundurkan diri dibandingkan karyawan yang menerima kategori salary lainnya.
...
___
5. Angka manakah yang baik untuk menjadi nilai `k`?
  - [ ] 85
  - [ ] 76
  - [X] 75
  - [ ] 38
...
Katakanlah kita bekerja sebagai staf HR pada suatu perusahaan. Kita ingin mengetahui manakah karyawan yang memiliki potensi tinggi untuk mengundurkan diri sehingga kita dapat melakukan pendekatan sesegera mungkin. Sebagai pertimbangan tambahan, perusahaan sedang dalam masa pemulihan dari krisis ekonomi belakangan ini, sehingga diharapkan bahwa kebanyakan hasil prediksi terbukti tepat untuk mencegah eksploitasi anggaran yang berlebih. Sekarang cobalah untuk menjawab pertanyaan di bawah ini.
